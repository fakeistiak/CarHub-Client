...
const ContactUs = () => {
    ...
    <div className="container px-6 py-12 mx-auto">
        <div className="text-center ">
            ...
            <h1 className="mt-2 text-2xl font-semibold md:text-3xl">We’d love to hear from you</h1>

            <p className="mt-3 dark">Chat to our friendly team.</p>
        </div>
        ...
        <div className="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-3 sm:grid-cols-2 ">
            <div className="p-4 rounded-lg shadow-xl shadow-purple-400 md:p-6">
                ...
                <p className="mt-2 text-sm dark">Speak to our friendly team.</p>
                <p className="mt-2 text-sm text-blue-500 dark:text-blue-400">Iabcars101@gmail.com</p>
            </div>
            ...
            <div className="p-4 rounded-lg shadow-xl shadow-purple-400 md:p-6">
                ...
                <p className="mt-2 text-sm text-blue-500 dark:text-blue-400">Gulshan 01,street 6 ,shop 101</p>
            </div>
            ...
            <div className="p-4 rounded-lg shadow-xl shadow-purple-400 md:p-6">
                ...
                <p className="mt-2 text-sm dark">Mon-Fri from 8am to 5pm.</p>
                <p className="mt-2 text-sm text-blue-500 dark:text-blue-400">+8801987654321</p>
            </div>
        </div>
    </div>
</section>
