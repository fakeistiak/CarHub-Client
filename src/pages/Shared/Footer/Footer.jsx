            ...
            <div className="mt-6 lg:mt-0 lg:flex-1">
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                    ...
                    <div>
                        ...
                        <a href="#" className="block mt-2 text-sm hover:underline">Mega cloud</a>
                        <a href="#" className="block mt-2 text-sm hover:underline">Aperion UI</a>
                        <a href="#" className="block mt-2 text-sm hover:underline">Meraki UI</a>
                    </div>
